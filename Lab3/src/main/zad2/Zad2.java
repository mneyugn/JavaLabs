...
class Zad2 {
    ...
    int solution(List<Integer> a) throws ArrayElementsOutOfRangeException, ArraySizeOutOfRangeException {
        ...
        if (b.get(0) < -1E6 || b.get(b.size() - 1) > 1E6) {
            throw new ArrayElementsOutOfRangeException("Wartość elementów tablicy jest poza zakresem");
        }
